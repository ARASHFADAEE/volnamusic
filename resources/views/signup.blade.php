					...
					<div class="sign__content">
						<form action="#" class="sign__form">
							...
							<div class="sign__group">
								<input type="text" class="sign__input" placeholder="نام">
							</div>
							...
							<div class="sign__group">
								<input type="password" class="sign__input" placeholder="رمز عبور">
							</div>

							<div class="sign__group sign__group--checkbox">
								<input id="remember" name="remember" type="checkbox" checked="checked">
								<label for="remember">من موافقم با <a href="privacy.html">سیاست حفظ حریم خصوصی</a></label>
							</div>
							
							<button class="sign__btn" type="button">ثبت نام</button>
							...
							<span class="sign__text">حساب دارید ؟ <a href="signin.html">وارد شوید!</a></span>
						</form>
					</div>
				</div>
			</div>
